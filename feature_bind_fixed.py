...
df_address.columns = [
        'UserInfo_2_wyscore','UserInfo_4_wyscore','UserInfo_7_wyscore',
        'UserInfo_19_wyscore']
...
textcat_column_names = [
        'UserInfo_9', 'UserInfo_22', 'UserInfo_23', 
        'Education_Info2', 'Education_Info3', 'Education_Info4', 
...
df_all1 = pd.concat([
    ...
    df_otext.reset_index(drop=True), df_address.reset_index(drop=True)], axis=1)
## 将train和test数据分开
